...
(banner_22000.bin) і Журналу дій (banner_22200.bin) у тій самій папці. Якщо
котрийсь із цих файлів видалити, Меню HOME не зможе прочитати той банер; на
решті перекладу це не позначиться.
