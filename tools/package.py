...
Здоров'я і безпека, Площа StreetPass Mii, Вибір Mii, Повідомлення,
Ігрові записи, екран помилки, інтернет-браузер, Nintendo eShop,
Перенесення даних, Nintendo Zone, Face Raiders, AR Games,
налаштування amiibo, аплет покупок і оновлень eShop, 3DS Memo,
аплет Circle Pad Pro, Miiverse, тексти помилок системи.
Плюс електронні довідники Інтернет-браузера й Налаштувань системи — обидва
повністю, разом із назвою додатка над сторінкою і пунктом "Українська"
в перемикачі мови довідника.
...
У Журналі дій, Керуванні даними, eShop і Перенесенні даних назви поки
лишаються російськими — кожен з них читає їх окремо.

ПРО ТИТУЛИ З ПРАВКОЮ КОДУ
Переклади Журналу дій, Посібника, Списку друзів, Вибору Mii, Повідомлень,
Гри по завантаженню, клавіатури, Здоров'я і безпеки, екрана помилки, аплета
покупок eShop, 3DS Memo та аплета Circle Pad Pro містять
правку коду титулу (файли code.ips та exheader.bin) і зроблені під Журнал дій
ВЕРСІЇ 2, Посібник ВЕРСІЇ 5, Список друзів ВЕРСІЇ 6, Вибір Mii ВЕРСІЇ 3,
Повідомлення ВЕРСІЇ 4, налаштування amiibo ВЕРСІЇ 1, Гру по завантаженню
...
Якщо котрийсь із них крешить — у вас старіший білд титулу. Видаліть його папку:
  ...
  Повідомлення          luma/titles/000400300000A002
...
самій консолі, а не в перекладних файлах. Тому в папці Посібника, крім тексту
...
ОКРЕМО ПРО ГРУ ПО ЗАВАНТАЖЕННЮ, КЛАВІАТУРУ, ЗДОРОВ'Я І БЕЗПЕКУ, ЕКРАН ПОМИЛКИ,
3DS MEMO ТА АПЛЕТ CIRCLE PAD PRO
Вони читають свій romfs просто з SD-карти (dlplay_romfs.bin, swkbd_romfs.bin,
safe_romfs.bin, error_romfs.bin, memolib_romfs.bin, extrapad_romfs.bin).
