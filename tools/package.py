...
Переклади Журналу дій, Посібника, Списку друзів, Гри по завантаженню й клавіатури містять
правку коду титулу (файли code.ips та exheader.bin) і зроблені під Журнал дій ВЕРСІЇ 2,
Посібник ВЕРСІЇ 5, Список друзів ВЕРСІЇ 6, Гру по завантаженню ВЕРСІЇ 3
і клавіатуру ВЕРСІЇ 4 для EUR.
...
ОКРЕМО ПРО ГРУ ПО ЗАВАНТАЖЕННЮ І КЛАВІАТУРУ
Вони читають свій romfs просто з SD-карти (dlplay_romfs.bin, swkbd_romfs.bin). Тому їхні
папки можна видаляти ТІЛЬКИ ЦІЛКОМ: якщо прибрати *_romfs.bin, а code.ips лишити, титул
перестане завантажуватись. Решти титулів це не стосується.
