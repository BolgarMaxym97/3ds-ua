...
ПРО ЖУРНАЛ ДІЙ І ПОСІБНИК
Їхні переклади містять правку коду титулу (файли code.ips та exheader.bin) і зроблені
під Журнал дій ВЕРСІЇ 2 і Посібник ВЕРСІЇ 5 для EUR. Це не версія системи: самі титули
Nintendo оновлювала одиниці разів, тож ці білди стоять на всіх сучасних прошивках,
включно з останньою 11.17.0-50. Спеціально нічого перевіряти не треба.
Якщо котрийсь із них усе ж крешить — у вас старіший білд титулу. Видаліть його папку:
