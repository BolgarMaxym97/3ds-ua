...
під Журнал дій ВЕРСІЇ 2, Посібник ВЕРСІЇ 5, Гру по завантаженню ВЕРСІЇ 3 для EUR.
...
ОКРЕМО ПРО ГРУ ПО ЗАВАНТАЖЕННЮ
Вона читає свій romfs просто з SD-карти (файл dlplay_romfs.bin). Тому її папку можна
видаляти ТІЛЬКИ ЦІЛКОМ: якщо прибрати dlplay_romfs.bin, а code.ips лишити, титул
