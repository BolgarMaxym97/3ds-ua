...
Здоров'я і безпека, Площа StreetPass Mii, Вибір Mii.

ПРО ТИТУЛИ З ПРАВКОЮ КОДУ
Переклади Журналу дій, Посібника, Списку друзів, Вибору Mii, Гри по завантаженню,
клавіатури та Здоров'я і безпеки містять правку коду титулу (файли code.ips та
exheader.bin) і зроблені під Журнал дій ВЕРСІЇ 2, Посібник ВЕРСІЇ 5, Список друзів
ВЕРСІЇ 6, Вибір Mii ВЕРСІЇ 3, Гру по завантаженню ВЕРСІЇ 3, клавіатуру ВЕРСІЇ 4
і Здоров'я і безпеку ВЕРСІЇ 3 для EUR. Площа StreetPass Mii везе тільки exheader.bin
