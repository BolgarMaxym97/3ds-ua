...
Повідомлення ВЕРСІЇ 4, Гру по завантаженню ВЕРСІЇ 3, клавіатуру ВЕРСІЇ 4,
Здоров'я і безпеку ВЕРСІЇ 3 і екран помилки ВЕРСІЇ 7 для EUR. Площа StreetPass Mii везе тільки exheader.bin
