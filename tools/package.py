...
ПРО ЖУРНАЛ ДІЙ, ПОСІБНИК І ГРУ ПО ЗАВАНТАЖЕННЮ
Їхні переклади містять правку коду титулу (файли code.ips та exheader.bin) і зроблені
під Журнал дій ВЕРСІЇ 2, Посібник ВЕРСІЇ 5, Гру по завантаженню ВЕРСІЇ 3
