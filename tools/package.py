...
замість "Россия" тепер Україна, з українськими областями.

УВАГА: "УКРАЇНА" В ПРОФІЛІ — ЦЕ КОД РОСІЇ
У таблиці кодів країн Nintendo України немає взагалі: європейський блок
суцільний, ...99 Румунія, 100 Росія, 101 Сербія... Тому мод не додає нову
країну, а перейменовує наявну — "Україна" в списку це той самий код 100.
Свою консоль ви бачите українською, але назву за цим кодом кожен читає своєю
таблицею: інші гравці в онлайні, NNID, eShop і StreetPass побачать "Росія".
Мод цього виправити не може — код країни це системна величина, від якої
залежать NNID, eShop і вікові рейтинги.
Якщо це важливо, поставте в профілі будь-яку іншу країну. Мова й країна в 3DS
ніяк не пов'язані: переклад стоїть на мовному слоті, тому інтерфейс лишиться
повністю українським з будь-якою країною в профілі.
