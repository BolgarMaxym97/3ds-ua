...
Той самий code.ips підміняє картинку Налаштувань системи на верхньому екрані —
вона читається з файлу luma/titles/0004003000009802/banner_22000.bin. Якщо цей
файл видалити, Меню HOME не зможе прочитати банер Налаштувань; на решті
...
Гри по завантаженню, клавіатури, Здоров'я і безпеки та екрана помилки містять
...
ВЕРСІЇ 3, клавіатуру ВЕРСІЇ 4, Здоров'я і безпеку ВЕРСІЇ 3 і екран помилки
ВЕРСІЇ 7 для EUR. Площа StreetPass Mii везе тільки exheader.bin
(без правки коду) і зроблена під ВЕРСІЮ 5.
...
ОКРЕМО ПРО ГРУ ПО ЗАВАНТАЖЕННЮ, КЛАВІАТУРУ, ЗДОРОВ'Я І БЕЗПЕКУ ТА ЕКРАН ПОМИЛКИ
Вони читають свій romfs просто з SD-карти (dlplay_romfs.bin, swkbd_romfs.bin,
safe_romfs.bin, error_romfs.bin). Тому їхні папки можна видаляти ТІЛЬКИ ЦІЛКОМ: якщо прибрати *_romfs.bin,
