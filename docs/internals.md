...
**Текст усередині електронних посібників.** Перекладено сам застосунок Посібника — `Назад`, `Збільшити`, `Мова`, `Стор.`, `Зміст`, діалог вибору мови. Документи, які він показує, тепер теж можна перекладати — але кожен окремо, і кожен спершу треба здампити з консолі. У 0.10.0 перекладено два повністю — Інтернет-браузер і Налаштування системи; решта показує рідний посібник консолі.
